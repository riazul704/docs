...
[![Build Status](https://doi-janky.infosiftr.net/job/multiarch/job/i386/job/docker/badge/icon) (`i386/docker` build job)](https://doi-janky.infosiftr.net/job/multiarch/job/i386/job/docker/)
